...
def vgg2_m(conv_layer, linear_layer, init_type, **kwargs):
...
def vgg2_bn_m(conv_layer, linear_layer, init_type, **kwargs):
    n = [i for i in cfgs["2"] if isinstance(i, int)][-1]
    model = VGG(
...
def vgg4_m(conv_layer, linear_layer, init_type, **kwargs):
...
def vgg4_bn_m(conv_layer, linear_layer, init_type, **kwargs):
    n = [i for i in cfgs["4"] if isinstance(i, int)][-1]
    model = VGG(
...
def vgg6_m(conv_layer, linear_layer, init_type, **kwargs):
...
def vgg6_bn_m(conv_layer, linear_layer, init_type, **kwargs):
    n = [i for i in cfgs["6"] if isinstance(i, int)][-1]
    model = VGG(
...
def vgg8_m(conv_layer, linear_layer, init_type, **kwargs):
...
def vgg8_bn_m(conv_layer, linear_layer, init_type, **kwargs):
    n = [i for i in cfgs["8"] if isinstance(i, int)][-1]
    model = VGG(
...
def vgg11_m(conv_layer, linear_layer, init_type, **kwargs):
...
def vgg11_bn_m(conv_layer, linear_layer, init_type, **kwargs):
    n = [i for i in cfgs["11"] if isinstance(i, int)][-1]
    model = VGG(
...
def vgg13_m(conv_layer, linear_layer, init_type, **kwargs):
...
def vgg13_bn_m(conv_layer, linear_layer, init_type, **kwargs):
    n = [i for i in cfgs["13"] if isinstance(i, int)][-1]
    model = VGG(
...
def vgg16_m(conv_layer= nn.Conv2d, linear_layer = nn.Linear, init_type = 'kaiming_normal', **kwargs):
...
def vgg16_bn_m(conv_layer= nn.Conv2d, linear_layer = nn.Linear, init_type = 'kaiming_normal', **kwargs):
    n = [i for i in cfgs["16"] if isinstance(i, int)][-1]
    model = VGG(
